...
- `0001-use-typescript-monorepo.md`: TypeScript monorepo
- `0002-use-cloudflare.md`: Cloudflare hosting
- `0003-central-backend-source-of-truth.md`: Central backend as source of truth
- `0004-unified-item-envelope.md`: Unified item envelope with type-specific details
